...
# Paper: XSimGCL - Towards Extremely Simple Graph Contrastive Learning for Recommendation 2022


class XSimGCL(GraphRecommender):
    def __init__(self, conf, training_set, test_set, valid_set):
        super(XSimGCL, self).__init__(conf, training_set, test_set, valid_set)
